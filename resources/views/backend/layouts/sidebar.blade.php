    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#customers" data-bs-toggle="collapse" href="#">
                <i class="bi bi-cart"></i><span>Customers</span><i class="bi bi-chevron-down ms-auto"></i>
            </a>
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#statistics" data-bs-toggle="collapse" href="#">
                <i class="bi bi-cart"></i><span>Statistics</span><i class="bi bi-chevron-down ms-auto"></i>
            </a>
            <ul id="statistics" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                <li>
                    <a href="components-alerts.html">
                ...
                <li>
                    <a href="components-accordion.html">
                        <i class="bi bi-circle"></i><span>Sales Performance</span>
                    </a>
                </li>
            </ul>
        </li><!-- End Products -->
